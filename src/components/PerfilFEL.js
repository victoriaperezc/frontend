...
function Divider2() {
  return <View style={styles.divider2} />;
}
function Divider() {
  return <View style={styles.divider} />;
}

const PerfilFEL = ({ navigation }) => {
  ...
  return (
    <View style={styles.backProfileDocuments}>
              ...
              <View style={styles.back}>
                ...
                <View style={styles.backOrderTasks}>
                  <Text style={styles.textDocumentsDocument}>
                    Completar formulario FEL
                  </Text>
                </View>
                <View style={styles.backOrderButton}>
                  <TouchableOpacity onPress={() => navigation.navigate('FormularioFel')}>
      ...
      <View style={styles.containerSiguiente}>
        <Button
          color="#D0D3D4"
          onPress={() => navigation.navigate('PerfilFirma')}
          title="Siguiente"
        />
      </View>
    </View>
